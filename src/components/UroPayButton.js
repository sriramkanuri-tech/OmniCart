...
export default function UroPayButton({
  productName,
  amount,
  productId,
  category = 'Shopping'
  ...
  return <a href="#" className="uropay-btn font-bold text-sm" data-uropay-api-key="5GNRS1IZYM2R54U8QIC52XB2GPN511UM" data-uropay-button-id="JULIET633209" data-uropay-environment="LIVE" data-uropay-amount={amount} data-uropay-success-redirect-url={successUrl} data-uropay-failure-redirect-url={failureUrl} style={{
    display: 'flex',
    width: '100%',
    height: '3.5rem',
    // h-14
