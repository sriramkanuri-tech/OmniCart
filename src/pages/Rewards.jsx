...
export default function Rewards() {
  ...
  >
    ...
    /* Main Tab Area */
      ...
      <AnimatePresence mode="wait">
        {activeTab === "rewards" ? <motion.section
    key="rewards_section"
  ...
  >
    ...
    rew.status === "Claimed" ? "bg-gray-100 text-gray-400" : "bg-purple-50 text-[#7C3AED]"
  )}>
                        {rew.status === "Claimed" ? <CheckCircle2 size={20} /> : <Percent size={20} />}
                      </div>
                      <span className={cn(
    "text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider",
    rew.status === "Claimed" ? "bg-gray-100 text-gray-500 border border-gray-150" : "bg-purple-50 text-[#7C3AED] border border-purple-100"
  )}>
                        {rew.status}
                      </span>
                    </div>
