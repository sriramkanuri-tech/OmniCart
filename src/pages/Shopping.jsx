    ...
    const fetchStorefrontData = async () => {
      try {
        ...
        if (res.data && res.data.length > 0) {
          const shoppingItems = res.data.filter(
            (p) => p.category === "Watches" || p.category === "Audio" || p.category === "Beauty" || p.category === "Furniture" || p.category === "Shopping"
          );
  ...
  >
    ...
    /* Categories Scroller */
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
        {["All Items", "Watches", "Audio", "Beauty", "Furniture"].map((cat, i) => <button
    key={i}
