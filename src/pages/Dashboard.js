...
import { ShoppingBag, Plane, Utensils, CreditCard, Smartphone, ReceiptText, Gift, Grid2X2, Search, Bell, ChevronRight, MapPin, Send, QrCode, History, Plus, ShieldCheck, Navigation, Hotel, Train, Bus, Headphones, User, Settings, LogOut, TrendingUp, X, CheckCircle2 } from 'lucide-react';
...
export default function Dashboard() {
  ...
  return <div className="space-y-8 pb-12 font-sans text-gray-900 relative">
      {/* Toast Alert */}
      <AnimatePresence>
        {alert.show && <motion.div initial={{
        opacity: 0,
        y: -50
      }} animate={{
        opacity: 1,
        ...
        opacity: 0,
        y: -50
      }} className={cn("fixed top-24 right-8 z-[100] flex items-center gap-3 px-6 py-4 rounded-2xl shadow-xl font-bold text-sm text-white", alert.success ? "bg-emerald-600" : "bg-red-600")}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-gradient-to-br from-[#7C3AED] to-[#5B21B6] rounded-[2.5rem] p-8 text-white shadow-xl shadow-purple-200">
            <div className="flex justify-between items-start mb-6">
              <div className="space-y-1">
                ...
                <p className="text-3xl font-bold">₹ {balance.toLocaleString('en-IN', {
                  minimumFractionDigits: 2
                })}</p>
              </div>
              <button onClick={() => navigate('/wallet')} className="bg-white/20 hover:bg-white/30 backdrop-blur-md rounded-full px-4 py-2 text-[10px] font-bold flex items-center gap-2 cursor-pointer transition-all">
          ...
          <div className="relative bg-[#FFF5F1] rounded-[2.5rem] p-8 overflow-hidden group">
            ...
            <img src="https://images.unsplash.com/photo-1629131726692-1accd1143ce0?q=80&w=200&auto=format&fit=crop" className="absolute right-[-20px] bottom-[-20px] w-48 opacity-40 group-hover:scale-110 transition-transform duration-700" alt="shopping" />
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
              ...
              image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=400&auto=format&fit=crop'
                ...
                <DealCard image="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=420&auto=format&fit=crop" name="boAt Headphones" price="₹1,499" original="₹2,499" discount="40% OFF" />
              </div>
              <div onClick={() => setCheckoutItem({
              ...
              image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=400&auto=format&fit=crop'
                ...
                <DealCard image="https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=200&auto=format&fit=crop" name="Nike Air Max" price="₹3,299" original="₹5,999" discount="45% OFF" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-8 text-[#1a1a1a]">
            ...
            <div className="bg-[#5B21B6] rounded-3xl p-6 text-white relative overflow-hidden">
               <div className="relative z-10 flex flex-col gap-1">
                 ...
                 <h4 className="text-2xl font-bold">₹ {balance.toLocaleString('en-IN', {
                  minimumFractionDigits: 2
                })}</h4>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              label: 'History'
                    ...
                    <button onClick={() => navigate('/wallet')} className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-gray-500 hover:bg-gray-100 hover:text-[#7C3AED] transition-colors cursor-pointer">
                       <item.icon size={18} />
                    </button>
            ...
            <div className="space-y-4">
               ...
               <div className="space-y-3">
                 {transactions.slice(0, 4).map((tx, idx) => <div key={tx.id || idx} onClick={() => setSelectedTx(tx)} title="Click to view digital receipt">
                     <TransactionRow icon={tx.type === 'in' ? '+' : '↓'} name={tx.title} date={tx.subtitle} amount={`${tx.type === 'in' ? '+' : '-'} ₹${tx.amount.toLocaleString('en-IN')}`} color={tx.type === 'in' ? "bg-green-150" : "bg-purple-50"} text={tx.type === 'in' ? "green-600" : "purple-600"} />
                   </div>)}
               </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative" onClick={() => navigate('/food')}>
                ...
                <input className="w-full bg-gray-50 border-none rounded-2xl py-3 pl-12 text-sm focus:ring-1 focus:ring-purple-200 cursor-pointer" placeholder="Search for restaurants or dishes..." readOnly />
              </div>

              <div className="flex gap-2 overflow-x-auto no-scrollbar py-2">
                {['All', 'Pure Veg', 'Biryani', 'Pizza', 'Burger'].map((cat, i) => <button onClick={() => navigate('/food')} key={i} className={cn("px-4 py-2 rounded-full text-xs font-bold whitespace-nowrap cursor-pointer hover:scale-105 transition-all", i === 0 ? "bg-[#7C3AED] text-white" : "bg-gray-50 text-gray-500")}>
                    {cat}
                  </button>)}
              </div>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div onClick={() => setCheckoutItem({
                name: 'Burger King Royal Box',
                price: '₹450',
                original: '₹750',
                discount: 'Free Delivery',
                image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=200&auto=format&fit=crop'
              })}>
                  <RestaurantCard image="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=200&auto=format&fit=crop" name="Burger King" meta="30-35 min • 4.3 ★" status="Free Delivery" />
                </div>
                <div onClick={() => setCheckoutItem({
                name: 'Pizza Hut Supreme Feast',
                price: '₹599',
                original: '₹999',
                discount: '₹40 OFF',
                image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=200&auto=format&fit=crop'
              })}>
                  <RestaurantCard image="https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=200&auto=format&fit=crop" name="Pizza Hut" meta="25-30 min • 4.2 ★" status="₹40 OFF above ₹299" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-6">
            ...
            <div className="space-y-4">
               ...
               <Button onClick={() => setFlightResults(true)} className="w-full h-14 rounded-2xl bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-bold text-sm tracking-wide cursor-pointer transition-colors">
                 Search flights
               </Button>
            </div>
          ...
          <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-6">
            ...
            <div className="space-y-4">
               <div onClick={() => setSelectedTx({
              title: 'Amazon Shopping Store',
              amount: 1499,
              ...
              status: 'Success'
               ...
               <div onClick={() => setSelectedTx({
              title: 'Uber Transport Services',
              amount: 350,
              subtitle: 'Journey • 1 day ago',
              status: 'Success'
            })}>
                 <HistoryRow icon="U" name="Uber Ride" meta="Trip to Airport" date="1 day ago" amount="350" />
               </div>
               <div onClick={() => setSelectedTx({
              title: 'Swiggy Eat-out Delivery',
              amount: 280,
              subtitle: 'Fast Food • 2 days ago',
              status: 'Success'
            })}>
      ...
      <AnimatePresence>
        {selectedTx && <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[95] flex items-center justify-center p-4">
            <motion.div initial={{
          scale: 0.95,
          opacity: 0
        }} animate={{
      ...
      <AnimatePresence>
        {checkoutItem && <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[95] flex items-center justify-center p-4">
            <motion.div initial={{
          scale: 0.95,
          opacity: 0
        }} animate={{
          ...
          opacity: 0
              ...
              <div className="space-y-2.5 border-t border-gray-100 pt-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs text-gray-800 font-bold">₹ {balance.toLocaleString('en-IN', {
                  minimumFractionDigits: 2
                })}</span>
                </div>
              </div>

              <button onClick={() => handleQuickBuy(checkoutItem)} className="w-full h-14 bg-[#7C3AED] hover:bg-purple-700 text-white font-bold text-sm rounded-2xl shadow-xl shadow-purple-100 transition-all cursor-pointer flex items-center justify-center gap-2">
      ...
      <AnimatePresence>
        {flightResults && <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[95] flex items-center justify-center p-4">
            <motion.div initial={{
          scale: 0.95,
          opacity: 0
        }} animate={{
          ...
          opacity: 0
              ...
              price: 3100,
              time: '2h 20m'
            }].map(fl => <div key={fl.id} className="p-5 border border-gray-100 bg-gray-50 rounded-2xl flex items-center justify-between hover:border-purple-200 transition-all">
                    <div>
                    ...
                    <div className="text-right">
                      ...
                      <button onClick={() => handleFlightBook(fl)} className="mt-1.5 px-4 py-2 bg-gray-900 hover:bg-[#7C3AED] text-white font-bold text-[10px] uppercase tracking-widest rounded-xl transition-all cursor-pointer">
                        Book
                      </button>
                    </div>
                  </div>)}
...
function WalletAction({
  ...
  return <div className="flex flex-col items-center gap-2 group cursor-pointer" onClick={onClick}>
...
function ServiceIcon({
  ...
  return <div className="flex flex-col items-center gap-2 group cursor-pointer text-center" onClick={onClick}>
...
function DealCard({
  ...
  return <div className="flex-shrink-0 w-44 bg-white rounded-[2rem] border border-gray-100 p-4 space-y-3 group cursor-pointer hover:shadow-lg transition-all">
...
function TransactionRow({
  ...
  return <div className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-2xl transition-all cursor-pointer">
...
function RestaurantCard({
  ...
  return <div className="flex items-center gap-3 group cursor-pointer p-2 hover:bg-gray-50 rounded-2xl transition-all">
...
function TravelTab({
  ...
  return <button onClick={onClick} className={cn("flex-1 flex items-center justify-center gap-2 py-3 rounded-xl transition-all cursor-pointer", active ? "bg-[#7C3AED] text-white shadow-lg shadow-purple-100" : "text-gray-400 hover:text-gray-600")}>
      <Icon size={14} />
...
function HistoryRow({
  ...
  return <div className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-2xl transition-all cursor-pointer select-none">
...
function FeatureItem({
  ...
  return <div className="flex items-center gap-3 p-6 bg-white rounded-3xl border border-gray-100">
...
function NotificationItem({
  ...
  return <div className="flex gap-3 p-3 hover:bg-gray-50 rounded-2xl transition-all cursor-pointer">
...
function ProfileLink({
  ...
  return <div className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-xl transition-all cursor-pointer group">
       <div className="flex items-center gap-3">
...
function AdminStat({
  ...
  return <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
...
function AdminLink({
  ...
  return <div className="flex items-center gap-3 text-white/60 hover:text-white transition-colors cursor-pointer">
       <Icon size={14} />
       <span className="text-[10px] font-bold">{label}</span>
    </div>;
}