...
import { 
  ShoppingBag, Clock, ShieldCheck, HelpCircle, ArrowRight, Plane, 
  Utensils, Calendar, HeartPulse, ShoppingCart, Filter, Search, X, CheckCircle2 
} from 'lucide-react';
    ...
    <div className="space-y-12 pb-12 font-sans relative">
      ...
      <section className="space-y-8 animate-fade-in">
        {filteredOrders.length === 0 ? (
          <div className="bg-white rounded-[3rem] p-20 text-center border border-gray-150 shadow-sm max-w-xl mx-auto space-y-4">
            ...
            {filteredOrders.map((ord) => (
              ...
              >
                <div className="flex gap-6">
                  {ord.image ? (
                    <div className="w-20 h-20 rounded-2xl overflow-hidden shrink-0 border border-gray-50 bg-gray-50 shadow-inner">
                    ...
                    <div className="w-20 h-20 rounded-2xl shrink-0 bg-gray-55 border border-gray-100 flex items-center justify-center shadow-inner text-[#7C3AED]">
