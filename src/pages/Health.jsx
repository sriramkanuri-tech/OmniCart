...
export default function Health() {
  ...
  const SERVICE_OFFERINGS = [
    { icon: Stethoscope, label: "Concierge Care", desc: "Direct 24/7 access to world-class private specialists.", price: 12e3, color: "bg-purple-50 text-[#7C3AED]" },
    ...
    /* Services Grid */
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {SERVICE_OFFERINGS.map((service, i) => <motion.div
    key={i}
    whileHover={{ y: -8 }}
  ...
  >
    ...
    /* Animated breathing visualizer ring */
              ...
              <div className="relative flex items-center justify-center h-52 w-52 mx-auto">
                <motion.div
    animate={{
      scale: breathText === "Inhale" ? 1.6 : breathText === "Hold" ? 1.6 : 1,
  ...
  />
                ...
                <motion.div
    animate={{
      scale: breathText === "Inhale" ? 1.3 : breathText === "Hold" ? 1.3 : 1
    }}
    transition={{ duration: 4, ease: "easeInOut" }}
