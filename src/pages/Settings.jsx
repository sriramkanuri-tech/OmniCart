...
export default function SettingsPage() {
  ...
  const [transactionLimit, setTransactionLimit] = useState(5e4);
  ...
  >
    ...
    return <button
      ...
      className={`w-full text-left p-6 rounded-[2rem] border transition-all flex items-start gap-4 ${isSelected ? "bg-white border-[#7C3AED] shadow-md ring-2 ring-purple-100" : "bg-white hover:bg-gray-50 border-gray-100 shadow-sm"}`}
    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4 items-center">
                    ...
                    <div className="flex gap-2">
                      {avatarPresets.map((preset, i) => <button
    key={i}
    type="button"
