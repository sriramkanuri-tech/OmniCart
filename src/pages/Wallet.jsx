...
export default function WalletPage() {
    ...
    /* Transaction History Section */
              ...
              <div id="ledger-transactions-section" className="space-y-8 scroll-mt-24">
                 ...
                 <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm overflow-hidden">
                   {transactions.length === 0 ? <div className="p-12 text-center text-gray-400 font-semibold text-sm">No transaction activities yet.</div> : transactions.map((tx, i) => <div key={tx.id} className={cn(
  ...
  />
                      <div className="grid grid-cols-4 gap-2 pt-2">
                        {["1000", "2000", "5000", "10000"].map((val) => <button
    key={val}
    type="button"
  ...
  >
    ...
    type="button"
    onClick={() => {
      const reGenerated = Math.floor(1e5 + Math.random() * 9e5).toString();
