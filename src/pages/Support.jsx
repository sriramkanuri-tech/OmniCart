...
export default function Support() {
  ...
  const handleSubmitComplaint = async (e) => {
    ...
    const newTkt = {
      id: `tkt-${Math.floor(1e4 + Math.random() * 9e4)}`,
      subject,
      category,
      message,
      email: "sriramkanuri45@gmail.com",
  ...
  >
    ...
    tkt.status === "Resolved" ? "bg-emerald-50 text-emerald-600 border-emerald-100" : tkt.status === "Dispatched" ? "bg-blue-50 text-blue-600 border-blue-100" : "bg-amber-50 text-amber-600 border-amber-100"
  )}>
                           {tkt.status}
                         </span>
                      </div>
  ...
  >
              ...
              <div className="space-y-3.5 text-xs">
                 ...
                 {dispatchStep >= 1 && <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-emerald-500/85">
                     ➔ Resolved MX server metrics for sriramkanuri45@gmail.com
                   </motion.p>}
                 {dispatchStep >= 2 && <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-emerald-500/85">
                     ➔ Negotiated perfect SSL/TLS symmetric cryptography
                   </motion.p>}
                 {dispatchStep >= 3 && <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-emerald-500/85">
