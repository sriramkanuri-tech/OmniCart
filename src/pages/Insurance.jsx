...
export default function Insurance() {
  ...
  const handlePlaceClaim = (e) => {
    ...
    triggerToast(`Claim loded! Ref ID: CLM-${Math.floor(1e5 + Math.random() * 9e5)} is under adjuster assessment.`);
  ...
  const POLICY_TYPES = [
    { icon: Home, title: "Home Insurance", val: "\u20B9 8.5Cr Comprehensive Cover", price: 15e3, color: "bg-blue-50 text-blue-600" },
    { icon: Car, title: "Motor Insurance", val: "Fully Active Zero-Dep Cover", price: 8500, color: "bg-orange-50 text-orange-600" },
    { icon: Heart, title: "Life Insurance", val: "\u20B9 2.5Cr Wealth Trust Cover", price: 22e3, color: "bg-red-50 text-red-600" },
    { icon: Briefcase, title: "Business Policy", val: "Elite Premium Liability Cover", price: 45e3, color: "bg-green-50 text-green-600" }
  ];
    ...
    /* Policy Categories */
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {POLICY_TYPES.map((item, i) => <motion.div
    key={i}
    whileHover={{ y: -8 }}
