...
export default function PaymentSuccess() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-purple-50/10 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50/50 flex items-center justify-center p-4">
      <motion.div 
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden p-8 text-center border border-purple-100">
          ...
          <p className="text-gray-500 mb-8 font-medium">
            {isConfirmed 
              ...
              : 'We are waiting for payment confirmation from UroPay.'}
          </p>
          ...
          <div className="bg-purple-50/25 rounded-2xl p-6 text-left mb-8 border border-purple-100/30">
            <div className="space-y-4 text-sm font-medium">
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <span className={`inline-flex items-center gap-1.5 px-3 py-1 text-xs font-bold rounded-full border uppercase ${
                  isConfirmed 
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-[#7c3aed] hover:bg-purple-700 text-white font-bold py-3.5 px-4 rounded-full transition-colors flex items-center justify-center gap-2 shadow-lg shadow-purple-200 cursor-pointer"
            >
              View My Orders
            ...
            <button
              ...
              className="w-full bg-white hover:bg-purple-50 text-[#7c3aed] font-bold py-3.5 px-4 rounded-full transition-colors flex items-center justify-center gap-2 border-2 border-purple-100 cursor-pointer"
            >
